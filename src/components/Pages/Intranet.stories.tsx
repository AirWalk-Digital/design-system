...
export const Primary: Story = {
    args: {
      motd: {
        ...
        message: 'This is a message of the day. It can be used to communicate important information to all employees.',
        brandFrom: 'one',
        brandTo: 'two',
      },
      header: {
        title: 'Your Company',
        logo: 'logos/cortex-reply.png',
        menuItems: [
          {
            name: 'Documentation',
            items: [
      ...
      customers: 
      [
        { name: "Acme Corp", logo: "/logos/reply.jpg", href: "#", gradientStart: "#3B82F6", gradientEnd: "#2563EB" },
        { name: "Globex", logo: "/logos/dropbox.png", href: "#", gradientStart: "#10B981", gradientEnd: "#059669" },
        { name: "Initech", logo: "/logos/customer1.png", href: "#", gradientStart: "#EC4899", gradientEnd: "#DB2777" },
        { name: "Umbrella", logo: "/logos/customer2.png", href: "#", gradientStart: "#F59E0B", gradientEnd: "#D97706" },
        { name: "Hooli", logo: "/logos/customer3.png", href: "#", gradientStart: "#8B5CF6", gradientEnd: "#7C3AED" },
        { name: "Pied Piper", logo: "/logos/customer1.png", href: "#", gradientStart: "#6EE7B7", gradientEnd: "#34D399" },
      ]
}
};
