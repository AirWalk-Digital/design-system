    ...
    <div className="w-full bg-primary text-white p-8 rounded-lg border border-dashed border-white/30">
      <div className="grid md:grid-cols-4 gap-8 relative">
        ...
        <div className="space-y-4">
          ...
          <h2 className="text-xl font-semibold">Significant Technical Expertise in Cloud, AI, & Data</h2>
          <p className="text-sky-200 text-sm">
            Our architects and engineers possess extensive expertise in designing, building, and operating modern,
            leading-edge technologies and enterprise-class solutions.
          </p>
          <p className="text-sm">
            We deploy highly experienced, multidisciplinary teams skilled in product delivery, architecture, software
        ...
        <div className="space-y-4">
          ...
          <h2 className="text-xl font-semibold">Deep Public Sector, FS, Regulatory & Security Expertise</h2>
          <p className="text-sky-200 text-sm">
            We understand how to navigate public sector and financial services regulation and how to deliver compliant and
            robustly secure cutting-edge solutions in this context.
          </p>
          <p className="text-sm">
            We have successfully completed projects for numerous public sector and Financial Services engagements, including
            XXX, XXXXXX XXXXXX, XXXXX XXXXXXXXXXXXXXX, XXXXXXXXXXXXXX and many other
            institutions.
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-sky-200 text-sm">
            We have collaborated closely with the XXXX since 2020 and understand its technology landscape and ambitions.
          </p>
          <p className="text-sm">
            As an XXXX strategic partner, we have led numerous transformation programmes, providing expertise in architectural
            design, engineering standards and technical leadership, and optimisations.
          </p>
        </div>
      </div>
    </div>
